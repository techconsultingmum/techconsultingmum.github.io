...
const useCases = [
  {
    ...
    description: 'Strategic guidance for organizations embarking on AI-driven transformation journeys.',
  },
  {
    title: 'AI Pilot Programs',
    description: 'Design and execute proof-of-concept initiatives to validate AI opportunities.',
  },
  {
    title: 'Enterprise AI Strategy',
    description: 'Comprehensive roadmaps aligning AI investments with business objectives.',
  },
];
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Strategic roadmaps to identify high-impact AI opportunities and prioritize implementations for maximum ROI.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
                See how strategic consulting drives AI success.
              </p>
